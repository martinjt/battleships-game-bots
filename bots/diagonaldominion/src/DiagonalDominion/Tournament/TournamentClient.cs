...
using DiagonalDominion.Tournament.Messages;
using DiagonalDominion.Tournament.Models;

namespace DiagonalDominion.Tournament;
...
public class TournamentClient : IDisposable
{
    ...
    public TournamentClient(TournamentConfig config, ILogger logger)
    {
        ...
        _shipPlacer = new DiagonalBiasShipPlacer();
        _firingStrategy = new DiagonalSweepFiringStrategy();
    }
